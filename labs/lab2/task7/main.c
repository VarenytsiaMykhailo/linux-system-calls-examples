...
int main() {
    ...
    if (fork_result) {
        printf("I am father after fork. My pid=%d ppid=%d gid=%d pgid=%d\n", getpid(), getppid(), getgid(), getpgid(getpid()));
        pause();
        ...
        printf("I am son. My pid=%d ppid=%d gid=%d pgid=%d\n", getpid(), getppid(), getgid(), getpgid(getpid()));
        setpgrp();
        printf("I am son. After setpgrp call pid=%d ppid=%d gid=%d pgid=%d\n", getpid(), getppid(), getgid(), getpgid(getpid()));
        pause();
